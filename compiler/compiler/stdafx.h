...
//Generator调试信息
#define OUTPUT_GENERATOR_ACTIONS (DEBUG_MODE && false)
#define OUTPUT_GENERATOR_SYMBOL_INFO (OUTPUT_GENERATOR_ACTIONS && false)
...
#define DEBUG_GENERATOR_SYMBOL(arg1, arg2) if(OUTPUT_GENERATOR_SYMBOL_INFO) { Debug::output(arg1, arg2); }
